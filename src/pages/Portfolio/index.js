                ...
                <div className="row">
                    <div className="col-md-12">
                        <a href="https://frozen-taiga-34472.herokuapp.com/">
                            <img src="assets/images/initpage.png" alt="SAS-SOS" class="img-thumbnail" />
                ...
                <div className="row">
                    ...
                    <div className="col-sm-6">
                        <a href="https://joannejavillo.github.io/employee-directory_react/">
                            <img src="assets/images/mainpage-asc.png" alt="employee-director-react" class="img-thumbnail" />
                    ...
                    <div className="col-sm-6">
                        <a href="https://joannejavillo.github.io/javascript-the_timed_quiz/">
                            <img src="assets/images/JS-TheTimedQuiz.png" alt="js-timed-quiz" class="img-thumbnail" />

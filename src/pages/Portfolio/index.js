                ...
                <div className="row">
                    <div className="col-md-12">
                        <a href="https://frozen-taiga-34472.herokuapp.com/">
                            <img src="./assets/initpage.png" alt="sas" className="img-thumbnail"/>
                    ...
                    <div className="col-md-12">
                        <a href="https://arcane-waters-44478.herokuapp.com/">
                            <img src="./assets/DCODE.png" alt="dcode" className="img-thumbnail"/>
                ...
                <div className="row">
                    ...
                    <div className="col-sm-6">
                        <a href="https://joannejavillo.github.io/employee-directory_react/">
                            <img src="./assets/mainpage-asc.png" alt="employee-director-react" className="img-thumbnail"/>
                    ...
                    <div className="col-sm-6">
                        <a href="https://joannejavillo.github.io/password-generator/">
                            <img src="./assets/passwordgen.png" alt="password-generator" className="img-thumbnail"/>
                    ...
                    <div className="col-sm-6">
                        <a href="https://joannejavillo.github.io/javascript-the_timed_quiz/">
                            <img src="./assets/JS-TheTimedQuiz.png" alt="js-timed-quiz" className="img-thumbnail"/>
